	...
	return (
		<div>
				<div>
				  ...
				  <column style={{"float": "center"}}><Flex justify='center' alignItems='center'><h1 className="title">Mesa Protocol</h1></Flex></column>
	      ...
	      <main>
	        <Grid templateColumns="repeat(2, 1fr)" gap={6}>
	        	...
	        	<Box w="100%" bg='#e5f4f1'>
			        ...
			        <Flex h='5vh' justify='center' alignItems='center'>
			        	<b><a href="https://github.com/vintageplayer/Mesa-Protocol">Github</a></b>&nbsp;|&nbsp;
